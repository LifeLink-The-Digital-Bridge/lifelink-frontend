...
export function useRecipientFormState(): RecipientFormState {
  ...
  const [cardiacStatus, setCardiacStatus] = useState("");
  const [pulmonaryFunction, setPulmonaryFunction] = useState("");
  const [overallHealthStatus, setOverallHealthStatus] = useState("");
  const [hasInfectiousDiseases, setHasInfectiousDiseases] = useState(false);
  const [infectiousDiseaseDetails, setInfectiousDiseaseDetails] = useState("");
  ...
  const [hlaA1, setHlaA1] = useState("");
  const [hlaA2, setHlaA2] = useState("");
  const [hlaB1, setHlaB1] = useState("");
  const [hlaB2, setHlaB2] = useState("");
  const [hlaC1, setHlaC1] = useState("");
  const [hlaC2, setHlaC2] = useState("");
  const [hlaDR1, setHlaDR1] = useState("");
  const [hlaDR2, setHlaDR2] = useState("");
  const [hlaDQ1, setHlaDQ1] = useState("");
  const [hlaDQ2, setHlaDQ2] = useState("");
  const [hlaDP1, setHlaDP1] = useState("");
  const [hlaDP2, setHlaDP2] = useState("");
      ...
      if (data) {
        try {
          ...
          if (recipient.medicalDetails) {
            ...
            setLiverFunctionTests(recipient.medicalDetails.liverFunctionTests || "");
            setCardiacStatus(recipient.medicalDetails.cardiacStatus || "");
          ...
          if (recipient.eligibilityCriteria) {
            ...
            setBodySize(recipient.eligibilityCriteria.bodySize || "");
          ...
          if (recipient.hlaProfile) {
            ...
            setTestingMethod(recipient.hlaProfile.testingMethod || "");
