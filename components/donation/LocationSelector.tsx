...
import { fetchDonorAddresses, addDonorAddress } from '../../app/api/donationApi';
...
export function LocationSelector({ selectedLocationId, onLocationSelect, donorId }: LocationSelectorProps) {
  ...
  const fetchLocations = async () => {
    ...
    try {
      ...
      const data = await fetchDonorAddresses(donorId);
      setLocations(data);
  ...
  const handleAddNewLocation = async () => {
    ...
    try {
      ...
      const newLocationData = await addDonorAddress(donorId, payload);
  ...
  return (
    <View style={styles.sectionContainer}>
      <View style={styles.sectionHeader}>
        ...
        <Text style={styles.sectionTitle}>Donation Location *</Text>
      </View>
