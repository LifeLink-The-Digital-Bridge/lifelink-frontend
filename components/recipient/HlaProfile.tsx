      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <Text style={{
            ...
            HLA Profile is required for organ matching
          </Text>
        </View>
        <Text style={{
          marginTop: 4,
          ...
          If you start entering HLA data, you must complete all 12 alleles and laboratory information for accurate matching.
        </Text>
      </View>
      ...
      {hasAnyHlaData && !isSectionComplete && (
        <View style={{
          ...
          <Text style={{
            ...
            You've started entering HLA data. Please complete all 12 HLA alleles and laboratory information to enable organ matching.
          </Text>
        </View>
      )}
